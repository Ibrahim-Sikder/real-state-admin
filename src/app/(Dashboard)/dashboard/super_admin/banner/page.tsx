      ...
      <DashboardCard>
        <Box>
          ...
          <Box display='flex' justifyContent='space-between'>
            <Typography variant="h5" fontWeight='bold'>Banner</Typography>
          ...
          <Box bgcolor="white" padding={3}>
            <TableContainer component={Paper}>
              <Table aria-label="simple table">
                ...
                <TableBody>
                  {bannerData?.data?.banners?.map((data: TOppressed, index: number) => (
                    <TableRow
                      key={data._id}
                    ...
                    >
                      ...
                      <TableCell align="center">
                        <Image width={50} height={50} className="w-20" src={data.profile} alt='activity' />
                      </TableCell>
