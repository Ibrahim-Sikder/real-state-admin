...
import { Box, Button, Grid, styled, TableCell, } from "@mui/material";
...
const CreateVideoModal = ({ open, setOpen }: TProps) => {
    ...
    const handleSubmit = async (values: FieldValues) => {
        ...
        try {
            const res = await createVideo(modifiedValues).unwrap();
                    ...
                    <ADForm onSubmit={handleSubmit}>
                        <FormSection>
                            ...
                            <Box display='flex' justifyContent='center' marginTop='20px' >
                                <Button type="submit" startIcon={<VideoCall />}>Add Video </Button>
                            </Box>
                        </FormSection>
                    </ADForm>
                </FormContainer>
