export const tableStyle  = { minWidth: 650, "& .MuiTableCell-root": { borderRight: "1px solid rgba(224, 224, 224, 1)" } }
...
export const paginateStyle ={ display: "flex", justifyContent: "space-between", alignItems: "center" }
